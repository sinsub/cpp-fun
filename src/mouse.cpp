...
void MouseButtonState::frame_reset() { down_ = up_ = false; }

void MouseButtonState::record_down(int x, int y) { down_ = true; }

void MouseButtonState::record_up(int x, int y) { up_ = true; }
